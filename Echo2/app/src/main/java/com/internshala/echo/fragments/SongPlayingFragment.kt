...
class SongPlayingFragment : Fragment() {
    ...
    object Staticated {
        ...
        fun updateTextViews(songTitle: String, songArtist: String) {
            ...
            if (songArtist.equals("<unknowns>", true)) {
    ...
    override fun onCreateView(
        ...
        val view = inflater!!.inflate(R.layout.fragment_song_playing3, container, false)
        ...
        Statified.shuffleImageButton = view?.findViewById(R.id.shuffButton)
